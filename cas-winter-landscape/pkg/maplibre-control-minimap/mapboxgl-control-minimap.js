...
Minimap.prototype = Object.assign({}, maplibregl.NavigationControl.prototype, {
	...
	_load: function ()
	{
		...
		miniMap.addSource("color", {
				type: "raster",
				...(((Array.isArray(opts.tiles) && opts.tiles.length)) && { tiles: opts.tiles }),
				...(opts.url && {url: opts.url}),
				attribution: 'Color Keyence'
		});
